 ...
 * @since 2.5
 */
public class IndexBasedCachingMetadataReaderFactory extends IndexBasedMetadataReaderFactory {
	 ...
	 */
	public IndexBasedCachingMetadataReaderFactory() {
		super();
	 ...
	 */
	public IndexBasedCachingMetadataReaderFactory(@Nullable ClassLoader classLoader) {
		super(classLoader);
		setCacheLimit(DEFAULT_CACHE_LIMIT);
	}
	 ...
	 */
	public IndexBasedCachingMetadataReaderFactory(@Nullable ResourceLoader resourceLoader) {
	...
	public MetadataReader getMetadataReader(Resource resource) throws IOException {
		if (this.metadataReaderCache instanceof ConcurrentMap) {
			...
			if (metadataReader == null) {
				...
				System.out.println("Using cached MR for "+resource);
			}
	...
	public static boolean indexExists(ResourceLoader resourceLoader) {
		return IndexBasedMetadataReaderFactory.indexExists(resourceLoader);
	}
