...
public class DefaultConversionService extends GenericConversionService {
	 ...
	 *        castable to ConversionService, e.g. being a
	...
	public static void addDefaultConverters(ConverterRegistry converterRegistry) {
		...
		converterRegistry.addConverter(
				new ByteBufferConverter((ConversionService) converterRegistry));
		converterRegistry.addConverter(String.class, TimeZone.class,
				new StringToTimeZoneConverter());
		converterRegistry.addConverter(ZoneId.class, TimeZone.class,
				new ZoneIdToTimeZoneConverter());
		converterRegistry.addConverter(ZonedDateTime.class, Calendar.class,
				new ZonedDateTimeToCalendarConverter());

		converterRegistry.addConverter(new ObjectToObjectConverter());
		converterRegistry.addConverter(
				new IdToEntityConverter((ConversionService) converterRegistry));
	...
	private static void addScalarConverters(ConverterRegistry converterRegistry) {
		...
		ObjectToStringConverter otsc = new ObjectToStringConverter();
		converterRegistry.addConverterFactory(new StringToNumberConverterFactory());
		converterRegistry.addConverter(Number.class, String.class, otsc);

		converterRegistry.addConverter(String.class, Character.class,
				new StringToCharacterConverter());
		converterRegistry.addConverter(Character.class, String.class, otsc);

		converterRegistry.addConverter(Number.class, Character.class,
				new NumberToCharacterConverter());
		converterRegistry.addConverterFactory(new CharacterToNumberFactory());

		converterRegistry.addConverter(String.class, Boolean.class,
				new StringToBooleanConverter());
		converterRegistry.addConverter(Boolean.class, String.class, otsc);
		...
		converterRegistry.addConverter(String.class, Locale.class,
				new StringToLocaleConverter());
		converterRegistry.addConverter(Locale.class, String.class, otsc);

		converterRegistry.addConverter(String.class, Charset.class,
				new StringToCharsetConverter());
		converterRegistry.addConverter(Charset.class, String.class, otsc);

		converterRegistry.addConverter(String.class, Currency.class,
				new StringToCurrencyConverter());
		converterRegistry.addConverter(Currency.class, String.class, otsc);

		converterRegistry.addConverter(String.class, Properties.class,
				new StringToPropertiesConverter());
		converterRegistry.addConverter(Properties.class, String.class,
				new PropertiesToStringConverter());

		converterRegistry.addConverter(String.class, UUID.class,
				new StringToUUIDConverter());
		converterRegistry.addConverter(UUID.class, String.class, otsc);
	}
